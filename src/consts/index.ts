...
export const CREATE_RESERVATION_ENDPOINT = "https://apihotelprod.1.us-1.fl0.io/api/Reservaciones/crear";

export const DELETE_RESERVATION_ENDPOINT = "https://apihotelprod.1.us-1.fl0.io/api/Reservaciones";
